...
* paso08: Publicar imágenes en ECR
* paso09: Desplegar con YAML en Kubernetes


# Ejecutar PASO 5 — Node Group EKS
...
```text
Bloque 3: Observabilidad — paso06 Metrics Server y paso07 CloudWatch
```

Y en paralelo:

```text
Bloque 4: Aplicación — paso08 ECR y paso09 Deploy YAML
```
