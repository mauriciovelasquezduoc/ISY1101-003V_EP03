...
flowchart LR
    ...
    subgraph ECR["🗄 Amazon ECR"]
        DB["alumnos-db<br/>(vacio)"]
        BACK["alumnos-backend<br/>(vacio)"]
        FRONT["alumnos-frontend<br/>(vacio)"]
    end
