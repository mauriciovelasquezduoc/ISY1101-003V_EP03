...
1. **Borra el namespace alumnos** → elimina Pods, Services, Deployments, HPA y el LoadBalancer
...
4. **Borra los repositorios ECR** → elimina `alumnos-db`, `alumnos-backend`, `alumnos-frontend` con sus imagenes
