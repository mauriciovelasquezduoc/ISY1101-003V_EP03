...
**Puerto:** 80  
**Backend que consume:** `http://alumnos-backend:3001` (DNS interno de Kubernetes)  
...
| Componente | Valor |
|---|---|
| **Clúster EKS** | `laboratorio-eks` (ACTIVE) |
...
```
$ kubectl get svc -n alumnos -l app=alumnos-frontend
NAME               TYPE           CLUSTER-IP    EXTERNAL-IP
alumnos-frontend    LoadBalancer   172.20.123.7  a5d87d...us-east-1.elb.amazonaws.com
```
...
```
$ kubectl get hpa alumnos-frontend-hpa -n alumnos
NAME                   REFERENCE           TARGETS       MINPODS MAXPODS REPLICAS
alumnos-frontend-hpa    Deployment/frontend cpu: 2%/60%   2       6       2
```
...
```
$ kubectl delete pod alumnos-frontend-757984d475-fs467 -n alumnos
...
```
$ kubectl logs deployment/alumnos-frontend -n alumnos --tail=5
...
```
...
```
$ kubectl top pods -n alumnos -l app=alumnos-frontend
NAME                               CPU(cores)   MEMORY(bytes)
alumnos-frontend-757984d475-fs467   2m           64Mi
alumnos-frontend-757984d475-l56nj   3m           58Mi
```
