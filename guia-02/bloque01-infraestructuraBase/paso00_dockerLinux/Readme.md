...
# Cargar usando una iamgen guardada

Una opción es utilizar la imagen que ya esta preparada, primero veamos como se extrae 
...
Con esto nos dara un listado de imagenes:

![1780599842277](image/Readme/1780599842277.png)

### Sacar la imagen de docker

Identificando el nombre de la imagen ya podemos sacarla:

```
docker save -o devops-eks-lab.tar devops-eks-lab:latest
```

Finalmente queda un archivo .tar que es la imagen que se puede compartir 

## Importar Imagen

Para importar la imagen solo basta con 

```
docker load -i devops-eks-lab.tar
```
