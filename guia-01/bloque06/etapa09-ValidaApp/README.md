...
2. Lista todos los Pods en el namespace `tienda`
...
flowchart LR
    ...
    N2["📋 kubectl get pods<br/>-n tienda"]
    N3["📋 kubectl get svc<br/>-n tienda"]
    N4["📋 kubectl get hpa<br/>-n tienda"]
    N5["📋 kubectl top pods<br/>-n tienda"]
